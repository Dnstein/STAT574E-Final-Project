...
#Plot locations
ggmap(idaho_map) +
  geom_point(aes(x = LON, y = LAT, color = "Plot Locations"), data = data.frame(grouped_dat), shape = 21, fill = "#a24857", color = "black", alpha = 0.75) +
...
```{r}
>>>>>>> 7131d3306dcd0981fdd1a0577562163368947fbd
...
pines_sf$DEADPROP_adj[pines_sf$DEADPROP == 0] <- 0.0001
#Replace observations of all dead with 0.99
pines_sf$DEADPROP_adj[pines_sf$DEADPROP == 1] <- 0.9999
...
# PLOT RESIDUALS ON MAP FOR SPATIAL AND NONSPATIAL MODEL ABOVE
```
